...

{
    ...
    public $updateMode = false, $photos, $show_table = true,

        $New_Password, $Old_Password,$pwd_fields_show=false ,
        // Father_INPUTS
        $Email, $Password,
        ...
        $Address_Mother, $Religion_Mother_id, $Parent_id;
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName, [
            ...
            'National_ID_Father' => 'required|min:10|max:10|string|regex:/[0-9]{9}/',
            'Passport_ID_Father' => 'required|min:10|max:10',
            'Phone_Father' => 'regex:/^([0-9\s\-\+\(\)]*)$/|min:10',
            'National_ID_Mother' => 'required|min:10|max:10|string|regex:/[0-9]{9}/',
            'Passport_ID_Mother' => 'required|min:10|max:10',
    ...
    public function submitForm_edit()
    {
        if ($this->Parent_id) {
            ...
            if ($this->Old_Password && $this->New_Password) {
                if (Hash::check($this->Old_Password, $My_Parent->Password)) {
                    $My_Parent->Password = Hash::make($this->New_Password);
                } else {
    ...
    public function pwd_fields()
    {
        $this->pwd_fields_show =true;
    }
