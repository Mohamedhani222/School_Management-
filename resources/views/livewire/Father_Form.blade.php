@if($currentStep != 1)
    <div style="display: none" class="row setup-content" id="step-1">
        ...
        <button class="btn btn-warning" wire:click="pwd_fields"
                type="button">{{trans('Parent_trans.change_password')}}
        </button>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    ...
                    @if($pwd_fields_show)
                        <div class="col">
                            <label for="title">{{trans('Parent_trans.old_password')}}</label>
                        ...
                        <div class="col">
                            <label for="title">{{trans('Parent_trans.new_password')}}</label>
