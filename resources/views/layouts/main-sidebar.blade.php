                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('classes.index')}}">{{trans('My_Classes_trans.List_classes')}}</a></li>
                        </ul>
                    </li>
                        ...
                        <ul id="students-menu" class="collapse">
                            <li>
                                ...
                                <ul id="Student_information" class="collapse">
                                    <li>
                                        <a href="{{route('students.create')}}">{{trans('main_trans.add_new_student')}}</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul id="Students_upgrade" class="collapse">
                                    <li>
                                        <a href="{{route('promotions.index')}}">{{trans('main_trans.add_Promotion')}}</a>
                                    </li>
                                    <li>
                                        <a href="{{route('promotions.create')}}">{{trans('main_trans.list_Promotions')}}</a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{URL('add-parent')}}">{{trans('main_trans.List_Parent')}} </a></li>
                        </ul>
                    </li>
